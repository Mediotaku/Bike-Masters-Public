...
## $(eval $(call AKS2C,sound/bikemasters-theme-new.aks,g_music,src/,0x70C8))
$(eval $(call AKS2DATA, CONVERT      , sound/bikemasters-theme-new.aks , g_music , 0x78C8 ))
$(eval $(call AKS2DATA, CONVERT      , sound/victoria.aks , g_victoria , 0x7C13 ))

$(eval $(call AKS2DATA, SET_SFXONLY  , yes   ))
$(eval $(call AKS2DATA, CONVERT      , sound/SFX-bikemasters.aks , g_sfx , 0x7800 ))
